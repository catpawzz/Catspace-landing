...
<body class="bg-gray-900">
    <div class="relative isolate overflow-hidden bg-gray-900">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">Contact</h1>
                <p class="mt-6 text-lg leading-8 text-gray-300">Contact the system administrators and server operators</p>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-6 py-10 text-white">
        ...
        <div class="_gaps">
            <section>
                <div class="_gaps">
                    <div class="_gaps xi0Lp" h="3"><span style="white-space: pre-wrap;">Administered by Catpawz</span>
