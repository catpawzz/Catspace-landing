...
<body class="bg-gray-900">
    ...
    <div class="container mx-auto px-6 py-10 text-white">
        ...
        <div class="_gaps">
            ...
            <section>
                <h2 class="h2">3. Data we collect</h2>
                <div class="_gaps">
                    <section>
            ...
            <section>
                <h2 class="h2">5. Data sharing</h2>
                <div class="_gaps">
                    <div class="_gaps xi0Lp" h="3"><span style="white-space: pre-wrap;">We do not share your personal data with third parties, except in the following cases:<br><br>- Legal Requirements: If required by law, we may disclose your information to comply with legal obligations.<br><br>- Service Providers: We may share your data with trusted service providers who help us operate our website. These providers are bound by confidentiality agreements.</span>
                        <div class="_gaps_s"></div>
                    </div>
                </div>
            </section><br><br>
            ...
            <section>
                ...
                <div class="_gaps">
                    <div class="_gaps xi0Lp" h="3"><span style="white-space: pre-wrap;">- Access: You have the right to request a copy of the personal data we hold about you.<br><br>- Correction: You can request that we correct any inaccuracies in your personal data.<br><br>- Deletion: You can request that we delete your account and associated data. Please note that some data may need to be retained to comply with legal obligations.<br><br>- Objection: You can object to our processing of your personal data under certain conditions.</span>
                        <div class="_gaps_s"></div>
                    </div>
                </div>
            </section><br><br>
